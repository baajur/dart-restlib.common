...
part "src/collections/bimap.dart";
part "src/collections/copy_on_write_bimap.dart";
part "src/collections/copy_on_write_list.dart";
part "src/collections/copy_on_write_map.dart";
part "src/collections/copy_on_write_list_multimap.dart";
part "src/collections/copy_on_write_set.dart";
part "src/collections/copy_on_write_stack.dart";
...
part "src/collections/persistent_map.dart";

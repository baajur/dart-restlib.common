...
class _ReverseSequence<E> extends SequenceBase<E> {
...
class _SubSequence<E> extends SequenceBase<E> {
...
abstract class SequenceBase<E> extends IterableBase<E> implements Sequence<E> {
  const SequenceBase();
...
class _MappedSequence extends SequenceBase implements Forwarder {
...
class ListAsSequence<T> extends SequenceBase<T> {
  ...
  const ListAsSequence(this.delegate);
